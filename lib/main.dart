          ...
          if (isDesktop) {
            return Padding(
              ...
              child: Row(
                ...
                children: [
                  Expanded(flex: 3, child: SingleChildScrollView(child: _buildControls())),
                  const SizedBox(width: 20),
                  Expanded(flex: 5, child: SingleChildScrollView(child: _buildViewer())),
                ],
              ),
            );
          } else {
            // FIXED MOBILE LAYOUT: Scrollable view with strictly bounded children
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // FIXED: Removed Expanded wrapper so it bounds to width on mobile
            Center(
              child: AspectRatio(
                aspectRatio: 1,
                child: Container(
            ...
            Row(
              children: [
                Expanded(child: ElevatedButton(
                  ...
                  child: const Text('Download High-Res (PNG)', textAlign: TextAlign.center),
                )),
                const SizedBox(width: 10),
                Expanded(child: ElevatedButton(
                  style: ElevatedButton.styleFrom(backgroundColor: Theme.of(context).colorScheme.secondary),
                  onPressed: _isProcessing ? null : () => _exportArtifact(true),
                  child: const Text('Compile Animation (GIF)', textAlign: TextAlign.center),
                )),
              ],
            )
          ],
